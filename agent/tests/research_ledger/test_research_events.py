...
def test_every_registered_payload_schema_validates_a_complete_production_shape() -> None:
    ...
    samples: dict[str, dict[str, object]] = {
        ...
        "ResolvedEvaluationContractRegistered": {
            "contract_id": "resolved-contract-fixture",
            ...
            "maximum_promotion": "forward_track",
            "evaluation_policy_event_hash": digest,
            "evaluation_policy_bundle_hash": digest,
            "producer_registry_hash": digest,
            "tier_invariant_manifest_hash": digest,
            "producer_schema_version": "resolved_evaluation_contract_service.v1",
            "producer_policy_hash": digest,
            "preregistration_watermark": digest,
            "artifact_refs": [
                {
                    "relative_path": "resolved-evaluation-contract-v1/fixture.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.resolved-evaluation-contract-v1+json",
                }
            ],
        },
        "ApplicabilityAssessmentRecorded": {
            "assessment_id": "applicability-fixture",
            "schema_version": "applicability_assessment.v1",
            "claim_type": "mechanism",
            "profile_template_hash": "sha256:" + "b" * 64,
            "resolved_contract_hash": "sha256:" + "a" * 64,
            "applicability_rule_id": "mechanism_claim_declared.v1",
            "applicability_rule_hash": digest,
            "factor_spec_id": "factor-1",
            "factor_definition_event_hash": "sha256:" + "c" * 64,
            ...
            "reason_code": "NO_MECHANISM_CLAIM_DECLARED",
            "producer_schema_version": "applicability_assessment_service.v1",
        ...
        "FactorOutputRecordedV3": {
            "factor_output_id": "factor-output-fixture",
            "factor_output_hash": digest,
            "factor_spec_id": "factor-1",
            "resolved_contract_hash": digest,
            "contract_event_hash": digest,
            "pit_snapshot_hash": digest,
            "pit_snapshot_event_hash": digest,
            "evaluation_policy_event_hash": digest,
            "factor_table_semantic_hash": digest,
            "source_event_hashes": [digest],
            "producer_schema_version": "pit_predictive_evidence_service.v4",
            "producer_policy_hash": digest,
            "artifact_refs": [
                {
                    "relative_path": "factor-output-v3/fixture.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.factor-output-v3+json",
                }
            ],
        },
        "ObservedPanelPredictiveEvidenceRecorded": {
            "evidence_id": "observed-fixture",
            "evidence_hash": digest,
            "evidence_type": "observed_panel",
            "factor_spec_id": "factor-1",
            "factor_output_hash": digest,
            "factor_output_event_hash": digest,
            "resolved_contract_hash": digest,
            "contract_event_hash": digest,
            "pit_snapshot_hash": digest,
            "pit_snapshot_event_hash": digest,
            ...
            "artifact_refs": [
                {
                    "relative_path": "predictive-evidence-v4/observed.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.predictive-evidence-v4+json",
                }
            ],
        },
        "PITPredictiveEvidenceRecorded": {
            "evidence_id": "pit-fixture",
            "evidence_hash": digest,
            "evidence_type": "pit_scoped",
            "factor_spec_id": "factor-1",
            "factor_output_hash": digest,
            "factor_output_event_hash": digest,
            "resolved_contract_hash": digest,
            ...
            "evidence_grade": "confirmatory",
            "promotion_effect": "blocked_pending_execution",
            "caps": ["PIT_AUTHORITY_UNAVAILABLE"],
            "warnings": [],
            "source_event_hashes": [digest],
            "producer_schema_version": "pit_predictive_evidence_service.v4",
            "producer_policy_hash": digest,
            "artifact_refs": [
                {
                    "relative_path": "predictive-evidence-v4/pit.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.predictive-evidence-v4+json",
                }
            ],
        ...
        "ScorecardDecisionEvidenceV4Recorded": {
            "evidence_id": "scorecard-v4-fixture",
            "scorecard_evidence_hash": digest,
            "factor_spec_id": "factor-1",
            "resolved_contract_hash": digest,
            "factor_output_hash": digest,
            "observed_evidence_hash": digest,
            "pit_evidence_hash": digest,
            "factor_output_event_hash": digest,
            "observed_event_hash": digest,
            "pit_event_hash": digest,
            "pit_predictive_authority": "unavailable",
            ...
            "artifact_refs": [
                {
                    "relative_path": "scorecard-decision-evidence-v4/fixture.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.scorecard-decision-evidence-v4+json",
                }
            ],
        },
        "ExecutionEvidenceRecorded": {
            "evidence_id": "execution-evidence-fixture",
            "factor_spec_id": "factor-1",
            "execution_artifact_hash": digest,
            "execution_decision_evidence_hash": digest,
            "factor_output_event_hash": digest,
            "observed_predictive_event_hash": digest,
            "resolved_contract_hash": digest,
            "availability": "partial",
            "implementability_claim": "inconclusive",
            "material_unpriced_exposure": True,
            "terminal_flat": False,
            "promotion_effect": "none",
            "caps": ["MATERIAL_UNPRICED_EXPOSURE"],
            "source_event_hashes": [digest],
            "producer_schema_version": "ashare_execution_evidence_service.v1",
            "producer_policy_hash": digest,
            "artifact_refs": [
                {
                    "relative_path": "execution-artifact-v1/fixture.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.execution-artifact-v1+json",
                },
                {
                    "relative_path": "execution-decision-evidence-v1/fixture.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.execution-decision-evidence-v1+json",
                },
            ],
        },
        "ProductionEvaluationNodeRecorded": {
            "node_id": "production-node-trial-1-source_resolution",
            "run_id": "run-1",
            "trial_id": "trial-1",
            "factor_spec_id": "factor-1",
            "resolved_contract_hash": digest,
            "node_name": "source_resolution",
            "status": "completed",
            "reason_codes": [],
            "source_event_hashes": [digest],
        ...
        "TrialTerminalDossierRecorded": {
            "dossier_id": "terminal-dossier-trial-1",
            "terminal_dossier_hash": digest,
            "trial_id": "trial-1",
            "factor_spec_id": "factor-1",
            ...
            "artifact_refs": [
                {
                    "relative_path": "trial-terminal-dossier-v1/fixture.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.trial-terminal-dossier-v1+json",
                }
            ],
        },
        "ReportMaterializationFailed": {
            "failure_id": "report-failure-trial-1",
            "trial_id": "trial-1",
            "terminal_event_hash": digest,
            "intended_dossier_hash": digest,
        ...
        "ProviderFieldPITAuditV1Recorded": {
            "audit_id": "provider-field-pit-v1-fixture",
            "adapter_registration_event_hash": digest,
            "provider": "fixture-provider",
            ...
            "field_audit_hash": digest,
            "canonical_hash_spec": {"spec_hash": digest},
            "audit": {"schema_version": "provider_field_pit_audit.v1"},
        },
        "ProviderInterfacePITAuditV1Recorded": {
            "audit_id": "provider-interface-pit-v1-fixture",
            "adapter_registration_event_hash": digest,
            "provider": "fixture-provider",
            "adapter_id": "fixture-adapter",
            "interface": "daily",
            "claim_scope_ceiling": "best_effort",
            "interface_audit_hash": digest,
            "field_audit_event_hashes": [digest],
            "canonical_hash_spec": {"spec_hash": digest},
            "audit": {"schema_version": "provider_interface_pit_audit.v1"},
        },
        "ProviderAuthorityDecisionV1Recorded": {
            "decision_id": "provider-authority-v1-fixture",
            "provider": "fixture-provider",
            "adapter_id": "fixture-adapter",
            "adapter_registration_event_hash": digest,
            ...
            "decision_hash": digest,
            "interface_audit_event_hashes": [digest],
            "canonical_hash_spec": {"spec_hash": digest},
            "decision": {"schema_version": "provider_authority_decision.v1"},
        },
        "ProductionGoldenSliceReadinessV1Recorded": {
            "readiness_id": "production-golden-slice-v1-fixture",
            "research_cycle_id": "activation-cycle-v2-fixture",
            "provider_authority_decision_event_hash": digest,
            "ready": False,
            "blocker_codes": ["PRODUCTION_GOLDEN_SLICE_UNAVAILABLE"],
            "readiness_hash": digest,
            "canonical_hash_spec": {"spec_hash": digest},
            "readiness": {"schema_version": "production_golden_slice_readiness.v1"},
        },
        "ProductionActivationRunInputBundleV1Registered": {
            "bundle_id": "production-activation-input-v1-fixture",
            "research_cycle_id": "activation-cycle-v2-fixture",
            "bundle_hash": digest,
            "resolved_contract_event_hash": digest,
            "provider_authority_decision_event_hash": digest,
            "golden_slice_readiness_event_hash": digest,
            "pit_snapshot_event_hash": digest,
        ...
        "ProductionActivationArmStartedV1Recorded": {
            "arm_start_id": "production-activation-arm-start-v1-fixture",
            "arm_start_hash": digest,
            "run_input_bundle_event_hash": digest,
            "plan_hash": digest,
            "pair_id": "pair-fixture",
            "run_group_id": "group-fixture",
            "arm": "flat",
            "retriever_policy_hash": digest,
            "retrieval_authority_event_hash": digest,
        },
        "ProductionActivationArmCompletedV1Recorded": {
            "arm_completion_id": "production-activation-arm-complete-v1-fixture",
            "arm_completion_hash": digest,
            "arm_started_event_hash": digest,
            "run_input_bundle_event_hash": digest,
            "plan_hash": digest,
            "pair_id": "pair-fixture",
            "run_group_id": "group-fixture",
            "arm": "flat",
            "retrieval_authority_event_hashes": [digest],
            "trial_terminal_event_hashes": [digest],
            "evaluation_event_hashes": [],
            "quality_decision_event_hashes": [],
            "terminal_dossier_event_hashes": [digest],
            "artifact_refs": [],
        },
        "ActivationPairEvidenceV2Recorded": {
            "pair_evidence_id": "activation-pair-evidence-v2-fixture",
            "pair_evidence_hash": digest,
            "projection_hash": digest,
            "plan_hash": digest,
            "pair_id": "pair-fixture",
            "run_group_id": "group-fixture",
            "flat_source_audit_hash": digest,
            "topology_source_audit_hash": digest,
            "source_event_hashes": [digest],
        ...
        "ActivationPilotDispersionV2Recorded": {
            "statistical_artifact_id": "activation-pilot-v2-fixture",
            "artifact_kind": "pilot",
        ...
        "ActivationConfirmatoryPlanV2Registered": {
            "statistical_artifact_id": "activation-confirmatory-v2-fixture",
        ...
        "ActivationStatisticalAnalysisV2Recorded": {
            "statistical_artifact_id": "activation-analysis-v2-fixture",
        ...
        "ActivationGovernanceDecisionV2Recorded": {
            "governance_decision_id": "activation-governance-v2-fixture",
        ...
        "ActivationReadinessV4Recorded": {
            "readiness_id": "activation-readiness-v4-fixture",
            "research_cycle_id": "activation-cycle-v2-fixture",
            "ready_for_pilot_outcome_access": False,
            "blocker_codes": ["PROVIDER_FIELD_AUDITS_SUFFICIENT"],
            "readiness_hash": digest,
            "readiness": {"schema_version": "activation_readiness.v4"},
        },
        "ActivationRunSourceAudited": {
        ...
        "ActivationResourceMeasuredV2": {
            ...
            "arm": "control",
            "manifest_hash": digest,
            "pair_schedule_event_hash": digest,
            "pair_schedule_hash": digest,
            "execution_claim_event_hash": digest,
            "arm_order_position": 0,
            "timeout_limit_seconds": 1.0,
            "measurement_policy_hash": digest,
            "wall_seconds": 0.0,
            "cpu_seconds": 0.0,
            "peak_rss_mb": None,
    ...
    def add_final_v2_samples() -> None:
        ...
        descriptor = {
            "provider_id": "final-raw-provider",
            "provider_version": "2.0.0",
            "provider_policy_hash": digest,
            "output_capability": "raw_bounded_parquet_partition_refs",
        }
        ...
        registration_hash = canonical_json_hash(registration_content)
        samples["FinalRawProviderV2Registered"] = {
        ...
        scope = {
            "schema_version": "final_scope_config.v2",
        ...
        dependence = {
            "schema_version": "final_dependence_config.v2",
            "method": "hac",
            ...
            "rank_ic_sesoi": 0.0,
            "net_return_sesoi": 0.0,
            "rank_ic_bounds": [-1.0, 1.0],
            "net_return_bounds": [-1.0, 10.0],
            "confidence_rule": "two_sided_lower_bound_gte_sesoi",
        }
        key_content = {
            "schema_version": "final_evaluation_key.v2",
            "research_family_id": digest,
            "scope_hash": canonical_json_hash(scope),
            "dependence_config_hash": canonical_json_hash(dependence),
            "producer_policy_hash": digest,
        }
        ...
        eligibility_content = {
            ...
            "factor_spec_id": "factor-1",
            "factor_definition_event_hash": digest,
            "prefinal_decision_hash": digest,
            "prefinal_decision": "research_only",
            "contract_hash": digest,
            "provider_registration_event_hash": digest,
            "scope_config": scope,
            "dependence_config": dependence,
            "final_evaluation_key": final_key,
            "producer_schema_version": producer_schema,
            "producer_policy_hash": digest,
        }
        eligibility_hash = canonical_json_hash(eligibility_content)
        samples["FinalEvaluationEligibilityRecorded"] = {
            ...
            "factor_spec_id": "factor-1",
            "factor_definition_event_hash": digest,
            "prefinal_decision_event_hash": digest,
            "prefinal_decision_hash": digest,
            "prefinal_decision": "research_only",
            "contract_event_hash": digest,
            "contract_hash": digest,
        ...
        capability_id = "final-v2-token-fixture"
        exact_scope_hash = canonical_json_hash({"scope_config": scope, "dependence_config": dependence})
        capability_content = {
            "token_id": capability_id,
            "eligibility_event_hash": digest,
            "eligibility_hash": eligibility_hash,
            "final_evaluation_key": final_key,
            "exact_scope_hash": exact_scope_hash,
            "issued_at": timestamp,
        }
        capability_hash = canonical_json_hash(capability_content)
        samples["FinalTestCapabilityV2Issued"] = {
        ...
        access_content = {
            "final_evaluation_key": final_key,
            "capability_hash": capability_hash,
            "request_scope_hash": exact_scope_hash,
            "outcome": "allowed",
            "taint_class": "none",
            "reason_code": "FINAL_V2_ACCESS_ALLOWED",
            "accessed_at": timestamp,
        }
        access_hash = canonical_json_hash(access_content)
        samples["FinalOutcomeAccessV2Recorded"] = {
        ...
        taint_hash = canonical_json_hash({"taint": "fixture"})
        samples["FinalContaminationV2Recorded"] = {
            ...
            "eligibility_event_hash": digest,
            "taint_class": "variant",
            "reason_code": "FINAL_VARIANT_FIXTURE",
        ...
        partition = {
            "relative_path": "final-raw/fixture.parquet",
            "artifact_hash": digest,
            "media_type": "application/vnd.apache.parquet",
            "partition_start": "2025-04-01",
            "partition_end": "2025-05-31",
            "row_count": 100,
        }
        bundle_content = {
        ...
        bundle_hash = canonical_json_hash(bundle_content)
        bundle = {**bundle_content, "bundle_hash": bundle_hash}
        metrics = {
            "effective_observations": 5,
            "rank_ic_mean": 0.02,
            "rank_ic_standard_error": 0.01,
            "rank_ic_lower_bound": 0.0004,
            "net_return_mean": 0.002,
            "net_return_standard_error": 0.001,
            "net_return_lower_bound": 0.00004,
            "quality_passed": True,
        }
        artifact_content = {
            ...
            "factor_spec_id": "factor-1",
            "eligibility_hash": eligibility_hash,
            "raw_partition_bundle_hash": bundle_hash,
            "dependence_config_hash": canonical_json_hash(dependence),
            "metrics": metrics,
            "contaminated": False,
            "limitations": ["FINAL_TEST_DECISION_ONLY"],
        }
        artifact_hash = canonical_json_hash(artifact_content)
        samples["FinalTestArtifactV2Recorded"] = {
            "artifact_id": "final-v2-artifact-" + artifact_hash[7:31],
            ...
            "access_event_hash": digest,
            "raw_partition_bundle_hash": bundle_hash,
            "raw_partition_bundle": bundle,
            "raw_partition_refs": [
                {
                    "relative_path": partition["relative_path"],
                    "artifact_hash": partition["artifact_hash"],
            ...
            "artifact_refs": [
                {
                    "relative_path": "final-v2/artifact.json",
                    "artifact_hash": digest,
                    "media_type": "application/vnd.vibe.final-test-artifact-v2+json",
                }
            ],
        }
        failure_content = {
        ...
        failure_hash = canonical_json_hash(failure_content)
        samples["FinalTestFailedV2Recorded"] = {
        ...
        selection_content = {
            ...
            "selective_nondisclosure": False,
            "confirmatory_grade_eligible": True,
        }
        selection_hash = canonical_json_hash(selection_content)
        samples["FinalSelectionAssessmentV2Recorded"] = {
            "assessment_id": "final-selection-" + selection_hash[7:31],
            "assessment_hash": selection_hash,
            **selection_content,
            "source_event_hashes": [digest],
            "producer_schema_version": producer_schema,
    ...
    forward_plan["plan_id"] = "forward-plan-" + str(forward_plan["plan_hash"]).removeprefix("sha256:")[:24]
    ...
    retriever_v4["decision_id"] = "retriever-v4-" + retriever_v4["decision_hash"].removeprefix("sha256:")[:20]
    ...
    retriever_v5["decision_id"] = "retriever-v5-" + retriever_v5["decision_hash"].removeprefix("sha256:")[:20]
    ...
    retriever_v6["decision_id"] = "retriever-v6-" + retriever_v6["decision_hash"].removeprefix("sha256:")[:20]
    ...
    retriever_v7["decision_hash"] = canonical_json_hash(
        {
            ...
            **{
                key: value
                for key, value in retriever_v7.items()
                if key not in {"decision_id", "decision_hash", "artifact_refs"}
            },
        }
    )
    retriever_v7["decision_id"] = "retriever-v7-" + retriever_v7["decision_hash"].removeprefix("sha256:")[:20]
...
def test_terminal_requires_start_and_infrastructure_cannot_promote(tmp_path: Path) -> None:
    ...
    with pytest.raises(EventValidationError, match="cannot promote"):
        store.append_event(_draft(event_type="TrialTerminated", entity_id="trial-orphan", payload=payload))
